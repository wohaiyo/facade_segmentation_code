...
def get_arguments():
    ...
    parser.add_argument("--data-dir", type=str, default='data/cmp/',
                        help="Training and evaluation facade dataset.")
    parser.add_argument("--eval-dir", type=str, default='data/cmp/eval/',
                        help="Training and evaluation facade dataset.")
    parser.add_argument("--dataset-size", type=int, default=606,
                        help="Number of training images.")
    parser.add_argument("--dataset-num-classes", type=int, default=5,
    ...
    parser.add_argument("--learning-rate", type=float,
                        default=2e-4, help="Base learning rate for training with polynomial decay.")
    ...
    parser.add_argument("--start-save-step", type=int, default=5000,
                        help="The step to start save checkpoint.")
    parser.add_argument("--save-step-every", type=int, default=5000,
    ...
    parser.add_argument("--save-dir", type=str, default='saves/cmp/',
                        help="The Snapshot save path.")
    parser.add_argument("--log-dir", type=str, default='logs/cmp/',
